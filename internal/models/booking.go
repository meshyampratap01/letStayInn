...
type Booking struct {
	...
	RoomID     string         `gorm:"type:uuid;not null;constraint:OnDelete:CASCADE,OnUpdate:CASCADE;" json:"room_id"`
	...
	Room Room `gorm:"foreignKey:RoomID;constraint:OnDelete:CASCADE,OnUpdate:CASCADE;"`
}
