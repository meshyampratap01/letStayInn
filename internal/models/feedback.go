...
type Feedback struct {
	...
	UserID    string         `gorm:"type:uuid;not null;constraint:OnDelete:SET NULL;" json:"user_id"`                        // Who submitted
	...
	RoomNum   int            `gorm:"constraint:OnDelete:SET NULL;" json:"room_num,omitempty"`                                       // Optional, linked room
